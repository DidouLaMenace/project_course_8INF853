...
set SERVICES=back-end\discovery-server back-end\gateway back-end\accounts-ms back-end\banking-ms back-end\catalog-ms back-end\commande-ms back-end\payments-ms back-end\booking-ms
