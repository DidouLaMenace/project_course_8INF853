...
public class InventoryController {
    ...
    // Endpoint pour récupérer les réservations par userId
    @GetMapping("/user/{userId}")
    public ResponseEntity<List<Inventory>> getInventoriesByUserId(@PathVariable Long userId) {
        List<Inventory> inventories = inventoryService.getInventoriesByUserId(userId);
        return ResponseEntity.ok(inventories);
    }
